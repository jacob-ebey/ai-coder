...
export async function remixRoute() {
  ...
  console.log({
    componentName: routeDesign.new_component_name,
    componentDescription: routeDesign.new_component_description,
    questionContext,
    importsContext,
  });
...
` +
        ...
        `$- Very important : loaders and actions should always be declared as \`export async function\` and NEVER as an arror function !\n` +
